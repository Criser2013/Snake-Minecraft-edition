...
function onKeyEvent (Mundo, keyCode) {
  ...
  if ((keyCode==UP_ARROW&&Mundo.dir.y!==1)&&Mundo.colision==false){
    ...
    window.open("perdido(alex-medio-overworld).html","_self")
  }
  else {
      console.log(keyCode);
      return update(Mundo, {});
