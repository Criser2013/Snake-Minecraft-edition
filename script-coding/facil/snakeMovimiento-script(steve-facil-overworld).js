...
function onTic(Mundo){
  ...
  //Esta condición determina si la cabeza del snake se encuentra en los límites laterales del mapa, para asi realizar el cambio de posición.
...
function onKeyEvent (Mundo, keyCode) {
  ...
  if (((keyCode==UP_ARROW||keyCode==87)&&Mundo.dir.y!==1)&&Mundo.colision==false){
    ...
    window.open("perdido(steve-facil-overworld).html","_self");
    return update(Mundo,{});
  }
  else {
    return update(Mundo,{});
