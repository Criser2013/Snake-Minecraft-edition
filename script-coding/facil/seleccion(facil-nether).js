...
function onKeyEvent (Mundo,keyCode) {
    ...
    //Estas 3 condiciones abre los archivos del juego con la apariencia seleccionada en su dificultad.
        ...
        window.open("snakeMovimiento(steve-facil-nether).html","_self")
    }
    else if (keyCode==ENTER&&Mundo.boton==3) {
        window.open("snakeMovimiento(porky-facil-nether).html","_self")
    }
    else if (keyCode==ENTER&&Mundo.boton==4) {
        window.open("snakeMovimiento(alex-facil-nether).html","_self")
    }
