...
function onTic(Mundo){
  ...
  //Esta condición determina si hubo colisión entre la cabeza del snake y la comida.
   ...
   //Esta condición es la encargada de hacer desaparecer el efecto de aumento de velocidad en la serpiente luego de 20 segundos 
    ...
    FPS;
    return update(Mundo,{snake: movimiento,trampas:trampas,obstaculos:{movil:{x:Mundo.obstaculos.movil.x,y:Mundo.obstaculos.movil.y},estatico:{x:Mundo.obstaculos.estatico.x,y:Mundo.obstaculos.estatico.y},respawn:false},contador:0});
  }
...
function onKeyEvent (Mundo, keyCode) {
  ...
  if (((keyCode==UP_ARROW||keyCode==87)&&Mundo.dir.y!==1)&&Mundo.colision==false){
    ...
    window.open("perdido(steve-dificil-overworld).html","_self");
    return update(Mundo,{});
  }
  else {
    return update(Mundo,{});
...
document.body.style.backgroundImage = "url('images/fondo_overworld_dificil.png')";