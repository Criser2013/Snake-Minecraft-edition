...
/**
 * Determina si la serpiente choco contra algún obstaculo (monstruo o comida envenenada).
...
function moveSnake(snake, dir) {
  ...
  // Realiza el traslado de un límite del mapa a otro.
  ...
  // Movimiento en el resto del mapa.
