...
function setup() {
  ...
  Mundo = {
    ...
    contador:0,
    obstaculos:{movil:{x:foodpos(),y:foodpos()},estatico:{x:foodpos(),y:foodpos()},respawn:false},
    sonidos:{muerte: new buzz.sound("audio/muerte",{formats:["mp3"],volume: 40,preload:true}),comer:new buzz.sound("audio/comiendo",{formats:["mp3"],volume: 40,preload:true})},
    enemigos:{primero:new buzz.sound("audio/endermite",{formats:["mp3"],volume: 40,preload:true}),segundo:new buzz.sound("audio/shulker",{formats:["mp3"],volume: 40,preload:true}),tercero:new buzz.sound("audio/enderman",{formats:["mp3"],volume: 40,preload:true}),cuarto:new buzz.sound("audio/enderdragon",{formats:["mp3"],volume: 40,preload:true})},
    reproductor:true,
    vidas:3,contador_vidas:0,invencibilidad:false};
}
/*
...
Ejemplos: drawCheat (4,7) -> image (4,7,20,20)
          drawCheat (1,1) -> image (1,1,20,20)
*/
...
function damage (serpiente,contador) {
  if ()
}*/
/*
